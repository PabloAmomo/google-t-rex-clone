...
const handleObstacles = () => {
  ...
  for (let i = 0; i < GAME_STATE.obstacles.length; i++) {
    ...
    obstacle.left() > -obstacle.width() && !GAME_STATE.isGameOver && setMove(obstacle, 'left', -(GAME_STATE.acceleration + PHYSICS.speed));
...
const restart = () => {
  Object.assign(GAME_STATE, { isGameOver: false, score: 0, acceleration: 0 });
